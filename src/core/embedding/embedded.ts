...
// The `Region` contract — the open-condition twin of `constraints/Constraint` — lives in
// `./types.ts`; the embedded set below is its sole instance (`isEmbedded` → `contains`,
// `clearance` → `margin`).
