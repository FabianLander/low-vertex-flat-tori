...
import type { Part, CellDomain } from '@display/mesh/part.ts';
import { makeFaces } from '@display/mesh/faces.ts';
import { makeEdges, type EdgesOptions } from '@display/mesh/edges.ts';
import { makeVertices } from '@display/mesh/vertices.ts';
import {
