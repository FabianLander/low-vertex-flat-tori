...
public class Manager  {
	...
	try{N.repaint();} catch(Exception e) {}
	try{Z.repaint();} catch(Exception e) {}
    }
    ...
    public boolean bundleCanvasAlive() {
	try {
	    boolean test=Z.alive;
	}
	catch(Exception e) {return false;}
	return true;
    }

    public boolean newtonCanvasAlive() {
	try {
	    boolean test=N.alive;
	}
	catch(Exception e) {return false;}
	return true;
    }

    public boolean platinumCanvasAlive() {
	try {
	    boolean test=X.alive;
	}
	catch(Exception e) {return false;}
	return true;
    }
